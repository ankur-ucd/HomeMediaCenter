...
#Build media directory structure
    ...
    sudo mkdir -p /configs/{emby,jellyseerr,prowlarr,qbit,radarr,recyclarr,sonarr,unpackerr,homarr}
    sudo chown -R apps:apps /media/{downloads,movies,tv}
    sudo chown -R apps:apps /configs /configs/{emby,jellyseerr,prowlarr,qbit,radarr,recyclarr,sonarr,unpackerr,homarr}
